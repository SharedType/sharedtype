...
import io.github.cuzfrog.sharedtype.domain.FieldComponentInfo;
import io.github.cuzfrog.sharedtype.domain.TypeVariableInfo;
import io.github.cuzfrog.sharedtype.it.support.TypeDefDeserializer;
...
final class JavaClassIntegrationTest {
    @Test
    void javaClass() {
        ClassDef classDef = (ClassDef)deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.JavaClass.ser");
        assertThat(classDef.components()).satisfiesExactly(
            ...
            size -> {
                ...
                assertThat(typeInfo.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.EnumSize");
            },
        ...
        assertThat(superType.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.SuperClassA");
    }

    @Test
    void anotherJavaClassShouldBeRenamed() {
        ClassDef classDef = (ClassDef)deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.other.JavaClass.ser");
    ...
    @Test
    void superClassA() {
        ClassDef classDef = (ClassDef) deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.SuperClassA.ser");
        assertThat(classDef.simpleName()).isEqualTo("SuperClassA");

        assertThat(classDef.supertypes()).hasSize(1);
        ConcreteTypeInfo superType = (ConcreteTypeInfo)classDef.supertypes().get(0);
        assertThat(superType.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.InterfaceA");
    ...
    @Test
    void interfaceA() {
        ClassDef classDef = (ClassDef)deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.InterfaceA.ser");
        assertThat(classDef.simpleName()).isEqualTo("InterfaceA");
        assertThat(classDef.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.InterfaceA");
        assertThat(classDef.components()).satisfiesExactly(
            value -> {
                assertThat(value.name()).isEqualTo("value");
    ...
    void shouldNotGenerateIgnoredTypes() {
        assertThat(TypeDefDeserializer.doesResourceExist("io.github.cuzfrog.sharedtype.it.java8.IgnoredInterfaceB.ser")).isFalse();
        assertThat(TypeDefDeserializer.doesResourceExist("io.github.cuzfrog.sharedtype.it.java8.IgnoredSuperClassB.ser")).isFalse();
    }

    @Test
    void innerClass() {
        ClassDef classDef = (ClassDef)deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.JavaClass.InnerClass.ser");
        assertThat(classDef.simpleName()).isEqualTo("InnerClass");
        assertThat(classDef.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.JavaClass.InnerClass");
        assertThat(classDef.components()).satisfiesExactly(
            value -> {
                assertThat(value.name()).isEqualTo("value");

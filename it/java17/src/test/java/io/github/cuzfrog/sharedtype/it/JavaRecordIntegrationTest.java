...
import io.github.cuzfrog.sharedtype.domain.ArrayTypeInfo;
...
final class JavaRecordIntegrationTest {
    private final ClassDef classDef = (ClassDef)deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java17.JavaRecord.ser");
    ...
    void supertypes() {
        ...
        assertThat(supertypeInfo.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.InterfaceA");
    }
    ...
    void cyclicDependencyField() {
        ...
        assertThat(typeInfo.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.DependencyClassA");
    }
    ...
    void containerStringListField() {
        ...
        assertThat(typeInfo.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.Container");
    ...
    void enumGalaxyField() {
        ...
        assertThat(typeInfo.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.EnumGalaxy");
    }

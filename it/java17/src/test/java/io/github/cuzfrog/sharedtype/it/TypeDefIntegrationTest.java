...
final class TypeDefIntegrationTest {
    @Test
    void container() {
        ClassDef container = (ClassDef) deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.Container.ser");
        SoftAssertions.assertSoftly(softly -> {
            softly.assertThat(container.simpleName()).isEqualTo("Container");
            softly.assertThat(container.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.Container");
    ...
    void dependencyClassA() {
        ClassDef classA = (ClassDef) deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.DependencyClassA.ser");
        SoftAssertions.assertSoftly(softly -> {
            softly.assertThat(classA.simpleName()).isEqualTo("DependencyClassA");
            softly.assertThat(classA.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.DependencyClassA");
            ...
            softly.assertThat(component1type.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.DependencyClassB");
            ...
            softly.assertThat(supertype1.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.SuperClassA");
    ...
    void dependencyClassB() {
        ClassDef classB = (ClassDef) deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.DependencyClassB.ser");
        assertThat(classB.simpleName()).isEqualTo("DependencyClassB");
    }

    @Test
    void dependencyClassC() {
        ClassDef classC = (ClassDef) deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.DependencyClassC.ser");
        assertThat(classC.simpleName()).isEqualTo("DependencyClassC");
    }

    @Test
    void enumGalaxy() {
        EnumDef enumGalaxy = (EnumDef) deserializeTypeDef("io.github.cuzfrog.sharedtype.it.java8.EnumGalaxy.ser");
        assertThat(enumGalaxy.simpleName()).isEqualTo("EnumGalaxy");
        assertThat(enumGalaxy.qualifiedName()).isEqualTo("io.github.cuzfrog.sharedtype.it.java8.EnumGalaxy");
